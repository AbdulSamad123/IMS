            ...
            <div class="box-body">
              <div class="row">
                ...
                <br>
                  ...
                  <?php
                    $select = $pdo->prepare("SELECT sum(total) as total, count(purchase_id) as purchase FROM tbl_purchase
              ...
              <div class="row">
                <div class="col-md-offset-2 col-md-4 col-xs-12">
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number"><?php echo $purchase; ?></span>
                    </div>
                    <!-- /.info-box-content -->
                  </div>
                  <!-- /.info-box -->
                ...
                <div class="col-md-offset-1 col-md-5 col-xs-12">
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text">Total Payemnt</span>
              ...
              <button onclick="tablePrint(#mySalesReport);" class="btn btn-primary"><i class="fa fa-print"></i> Print Report</button>
                  <table class="table table-striped" id="mySalesReport">
                      ...
                      <tbody>
                      <?php
                            $select = $pdo->prepare("SELECT tbl_supplier.name, tbl_purchase.order_date, tbl_purchase.total, tbl_purchase_detail.product_name, tbl_purchase_detail.qty FROM tbl_purchase join tbl_supplier on tbl_purchase.supplier_id=tbl_supplier.supplier_id JOIN tbl_purchase_detail on tbl_purchase_detail.purchase_id=tbl_purchase.purchase_id where tbl_purchase.order_date BETWEEN :fromdate AND :todate");
                            $select->bindParam(':fromdate', $_POST['date_1']);
                            $select->bindParam(':todate', $_POST['date_2']);
              ...
              <!-- Transaction Graphic -->
              <?php
                  $select = $pdo->prepare("SELECT order_date, sum(total) as price FROM tbl_purchase WHERE order_date BETWEEN :fromdate AND :todate
                  GROUP BY order_date");
                  $select->bindParam(':fromdate', $_POST['date_1']);
                  $select->bindParam(':todate', $_POST['date_2']);
                  $select->execute();
              ...
              <?php
                  $select = $pdo->prepare("SELECT product_name, sum(qty) as q FROM tbl_purchase_detail WHERE order_date BETWEEN :fromdate AND :todate
                  GROUP BY product_id");
                  $select->bindParam(':fromdate', $_POST['date_1']);
                  $select->bindParam(':todate', $_POST['date_2']);
                  $select->execute();

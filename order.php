<?php
    ...
    if($delete->execute()){
        echo'<script type="text/javascript">
            ...
            swal("Info", "Sales has been deleted", "info", {
            button: "Continue",
                });
            });
            </script>';
    ...
    <section class="content container-fluid">
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <a href="create_order.php" class="btn btn-success btn-sm pull-right">Create Sales</a>
            </div>
            <div class="box-body">
                <div style="overflow-x:auto;">
                    <table class="table table-striped" id="myOrder">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $select = $pdo->prepare("SELECT tbl_customer.name , tbl_invoice.invoice_id, tbl_invoice.order_date, tbl_invoice.total from tbl_invoice join tbl_customer on tbl_customer.customer_id=tbl_invoice.customer_id  ORDER BY tbl_invoice.invoice_id DESC");
                            $select->execute();
                            ...
                            ?>
                                ...
                                <td>
                                    ...
                                    <a href="order.php?id=<?php echo $row->invoice_id; ?>" onclick="return confirm('Remove Sales?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                    <?php } ?>

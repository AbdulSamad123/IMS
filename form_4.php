...
isset( $_SESSION['name'] );
$supplier_id = $_SESSION['name'];
$date_1 = $_SESSION['date_1'];
$date_2 = $_SESSION['date_2'];

$query = "Select name as cus from tbl_supplier where supplier_id= '$supplier_id'";
...
$quer = "Select Sum(total) as sum from tbl_purchase where supplier_id = '$supplier_id'and order_date BETWEEN '$date_1' AND '$date_2'";
...
$putin;
$qu = "Select Sum(received) as sum from tbl_pay where supplier_name = '$putin'and date BETWEEN '$date_1' AND '$date_2'";
...
$bal = "Select Sum(due) as sum from tbl_purchase where supplier_id = '$supplier_id' and order_date < '$date_1'";
...
<body>
    <div class="container" id="content">
        ...
        <h3 class="text-center">Sales Report</h3>
                <div class="row">
                    <div class="col"> <strong>Supplier's Name</strong></div>

                    ...
                    <table class="table table-striped" id="myProduct">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <td>Rp <?php echo number_format($row->purchase_price,2);?></td>
                                <td>Rp <?php echo number_format($row->sell_price,2); ?></td>
                                ...
                                <td>
                                    ...
                                    <a href="product.php?id=<?php echo $row->product_id; ?>" onclick="return confirm('YOU ARE Delete this ?')"
